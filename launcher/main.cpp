/*
 * Pentagram Unified Launcher
 * 
 * This launcher provides a unified interface for Ultima games:
 * - Pentagram (Ultima VIII: Pagan)
 * - Exult (Ultima VII: The Black Gate / Serpent Isle)
 * - ScummVM Ultima8 (Ultima VIII: Pagan - alternative engine)
 * 
 * Copyright (C) 2026 Pentagram Team
...
UltimaLauncher::UltimaLauncher() {
    ...
    games = {
        {
            "u8",
            "Ultima VIII: Pagan (Pentagram)",
            "The Avatar is banished to the dark world of Pagan. Play with Pentagram engine.",
            "pentagram",
            "pentagram",
            "ultima8",
            false
        ...
        {
            "u8scummvm",
            "Ultima VIII: Pagan (ScummVM)",
            "The Avatar is banished to the dark world of Pagan. Play with ScummVM engine.",
            "scummvm",
            "scummvm --path=",
            "ultima8",
            false
...
void UltimaLauncher::launchGame(const GameInfo& game) {
    ...
    if (game.engine == "pentagram") {
        command = "pentagram";
    } else if (game.engine == "exult") {
        command = "exult";
        if (game.id == "u7si") {
            command += " --si";
        }
...
int main(int argc, char* argv[]) {
    std::cout << "Pentagram Unified Launcher" << std::endl;
    std::cout << "==========================" << std::endl;
